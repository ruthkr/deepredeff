...
This package requires TensorFlow 2.0, for this reason we recommend first running:
...
In some operating systems, you may also require to specify the `conda` path of your `r-miniconda` installation when calling `reticulate::conda_install()`.
