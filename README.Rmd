...
The `deepredeff` package uses Tensorflow. If you already have TensorFlow in your system, then you can specify your environment where TensorFlow is installed using `reticulate::use_condaenv()`. Otherwise, you can install TensorFlow, by using install_tensorflow() function as follows:
