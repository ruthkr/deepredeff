...
The deepredeff package uses the Keras and tensorflow. To install both the core Keras library as well as the TensorFlow backend use the install_keras() function:
...
This will provide you with default CPU-based installations of Keras and TensorFlow. If you want a more customized installation, you can see the documentation for install_keras().
