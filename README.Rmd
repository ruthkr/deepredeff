...
**deeffpred** is a package for prediction an effector given amino acid sequence of a protein. This tool can be used to predict effectors from three different pathogens, which are oomycete, fungi, and bacteria.  
