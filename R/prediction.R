...
#' \item{`prediction`}{class prediction for each sequence, obtained from s_score. If the value of `s_score` ≥ 0.5, it will be clasified as an effector. Otherwise, it will be claasified as a non-effector.}
#'
#' @export
#'
